        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li class="colors__item" v-for="item in product.colors">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio" name="color-item" value="blue" checked="">
                    <span class="colors__value" :style="filterInputColor(item.code)">
                    </span>
                  </label>
                </li>
            ...
            <div class="item__row">
              <div class="form__counter">
                <button type="button" aria-label="Убрать один товар" @click.prevent="amounted(productAmount-1)">
                ...
                <button type="button" aria-label="Добавить один товар" @click.prevent="amounted(productAmount+1)">
                  <svg width="12" height="12" fill="currentColor">
